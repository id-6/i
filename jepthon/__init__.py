...
__version__ = "1.0.0"
__license__ = "كـتابة وتـعديل فريـق بيثون"
__author__ = "بيثون <https://T.ME/Bethon2>"
__copyright__ = "Bethon2 TEAM (C) 2020 - 2021  " + __author__

jepiq.version = __version__
jepiq.tgbot.version = __version__
LOGS = logging.getLogger("Bethon")
bot = jepiq
